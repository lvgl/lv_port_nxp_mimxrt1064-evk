...
lvgl/lvgl/src/extra/layouts/grid/%.o: ../lvgl/lvgl/src/extra/layouts/grid/%.c lvgl/lvgl/src/extra/layouts/grid/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2f-lvgl-2f-src-2f-extra-2f-layouts-2f-grid

clean-lvgl-2f-lvgl-2f-src-2f-extra-2f-layouts-2f-grid:
	-$(RM) ./lvgl/lvgl/src/extra/layouts/grid/lv_grid.d ./lvgl/lvgl/src/extra/layouts/grid/lv_grid.o

.PHONY: clean-lvgl-2f-lvgl-2f-src-2f-extra-2f-layouts-2f-grid
